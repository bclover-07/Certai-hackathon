...
export const CERTNFT_ADDRESS = (process.env.NEXT_PUBLIC_CERT_NFT_ADDRESS || (deployed && deployed.contracts && deployed.contracts.CertNFT) || "0x5FbDB2315678afecb367f032d93F642f64180aa3") as `0x${string}`;
export const CERTVERIFIER_ADDRESS = (process.env.NEXT_PUBLIC_CERT_VERIFIER_ADDRESS || (deployed && deployed.contracts && deployed.contracts.CertVerifier) || "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512") as `0x${string}`;
export const PEERENDORSE_ADDRESS = (process.env.NEXT_PUBLIC_PEER_ENDORSE_ADDRESS || (deployed && deployed.contracts && deployed.contracts.PeerEndorse) || "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0") as `0x${string}`;
