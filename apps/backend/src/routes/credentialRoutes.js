...
const { getCredentials, getCredential, getHolderCredentials, updateCredentialStatus, upgradeTrustLevel, revokeCredential } = require('../controllers/credentialController');
